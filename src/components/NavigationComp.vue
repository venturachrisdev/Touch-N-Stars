      ...
      <div class="flex space-x-2 px-2 lg:px-0" style="scroll-snap-align: start">
        ...
        <div v-if="store.imageHistoryInfo && store.imageHistoryInfo.length > 0">
          <router-link
            ...
            :title="$t('components.navigation.sequence')"
          >
          <svg fill="#FFFFFF" height="400px" width="400px" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="-100 0 639.479 439.479" xmlns:xlink="http://www.w3.org/1999/xlink" enable-background="new 0 0 439.479 439.479">
            <g>
