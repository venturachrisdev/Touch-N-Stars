<template>
          ...
          <div class="flex flex-col space-y-2">
            <button
              ...
              @click="
                cameraStore.getCameraRotation(apiService, cameraStore.exposureTime, cameraStore.gain)
              "
          ...
          <div v-if="cameraStore.plateSolveError" class="p-4 mt-2 text-center bg-red-500/20 border border-red-500/70 rounded-lg">
