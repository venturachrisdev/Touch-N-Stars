<template>
  ...
  function onDrag(e) {
    ...
    if (x.value > containerSize - framingStore.camWidth) x.value = containerSize - framingStore.camWidth;
    if (y.value > containerSize - framingStore.camHeight) y.value = containerSize - framingStore.camHeight;
