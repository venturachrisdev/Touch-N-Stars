<template>
  <div class="p-4 space-y-4">
    ...
    <div v-if="globalTriggers.length > 0"
      ...
      <div v-if="!store.isCollapsed('GlobalTrigger')"
...
const globalTriggers = computed(() => {
  ...
  const containerWithTriggers = store.sequenceInfo.find(container => 
    container.GlobalTriggers && container.GlobalTriggers.length
  );
