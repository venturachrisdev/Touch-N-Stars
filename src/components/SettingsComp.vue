    ...
    <div class="bg-gray-800 p-4 rounded-lg">
      ...
      <div class="space-y-4">
        ...
        <div class="bg-gray-700 p-3 rounded-lg">
          ...
          <!-- Instance List -->
          <div class="mb-4">
            <div v-for="instance in instances" :key="instance.id" class="bg-gray-600 p-2 rounded mb-2">
              <div class="flex items-center justify-between">
                ...
                <div class="flex gap-2">
                  <button @click="selectInstance(instance)"
                    :class="['p-1 transition-colors', selectedInstance === instance.id ? 'text-green-500' : 'text-gray-300 hover:text-green-500']"
          ...
          <div class="space-y-2">
            <div>
              ...
              <input v-model="tempInstance.name" type="text"
                class="w-full px-3 py-2 bg-gray-600 text-gray-300 rounded-md focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500"
                placeholder="Instance Name" />
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-400 mb-1">IP</label>
              <input v-model="tempInstance.ip" type="text"
                class="w-full px-3 py-2 bg-gray-600 text-gray-300 rounded-md focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500"
                placeholder="192.168.x.x" />
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-400 mb-1">Port</label>
              <input v-model="tempInstance.port" type="text"
                class="w-full px-3 py-2 bg-gray-600 text-gray-300 rounded-md focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500"
                placeholder="5000" />
            </div>
            <button @click="saveInstance"
              class="w-full mt-2 px-4 py-2 bg-cyan-600 hover:bg-cyan-500 text-white rounded-md transition-colors">
